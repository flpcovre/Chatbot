...
class _UserRegisterState extends State<UserRegister> {
  ...
  final TextEditingController _firstPasswordTextController =
      TextEditingController();
  final TextEditingController _secondPasswordTextController =
      TextEditingController();
                      ...
                      SizedBox(
                        ...
                        child: Padding(
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () async {
                              bool isCreated = await _loginController.signUp(
                                  _nameTextController.text,
                                  _userTextController.text,
                                  _firstPasswordTextController.text,
                                  _secondPasswordTextController.text);
                              if (isCreated) {
                                setState(() {
